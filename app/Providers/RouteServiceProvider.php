...
class RouteServiceProvider extends ServiceProvider
{
    ...
    protected $namespace_landing = 'App\\Http\\Controllers';
    protected $namespace_client = 'App\\Http\\Controllers\\Client';
    ...
    public function boot()
    {
        ...
        $this->routes(function () {
            ...
            Route::middleware('web')
                ->namespace($this->namespace_landing)
                ->group(base_path('routes/landing.php'));

            Route::middleware('web')
                ->namespace($this->namespace_client)
