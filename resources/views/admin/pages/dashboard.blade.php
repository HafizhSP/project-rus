...
@push('script')
<!-- Page JS Plugins -->
<script src="{{ asset('panel/assets/js/plugins/jquery-sparkline/jquery.sparkline.min.js') }}"></script>
<script src="{{ asset('panel/assets/js/plugins/chart.js/Chart.bundle.min.js') }}"></script>

<!-- Page JS Code -->
<script src="{{ asset('panel/assets/js/pages/be_pages_dashboard.min.js') }}"></script>
